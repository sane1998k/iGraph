...
function getBuild() {
   ...
   //             correctedDate = new Date(data.result[i][0]);
   //             data.result[i][0] = correctedDate.getTime() - correctedDate.getTimezoneOffset() * 60000;
   //          }
   ...
   //                events: {
   //                   load: function () {
   //                      document.getElementsByClassName("highcharts-range-selector-buttons")[0].firstChild.textContent = "Увел.";
   //                      document.getElementsByClassName("highcharts-range-label")[0].firstChild.textContent = "С";
   //                      document.getElementsByClassName("highcharts-range-label")[1].firstChild.textContent = "По";
   //                   }
   //                }
   //             },
